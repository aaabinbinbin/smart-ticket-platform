param(
    ...
    # .\run_rag_pgvector_e2e_v4.ps1 -UseSshPgCheck $true -LinuxSshTarget "youruser@192.168.100.128"
...
Step "10. What to check in IDEA logs"
Write-Host "Look for these logs:" -ForegroundColor Yellow
Write-Host "1. ticket knowledge task started/completed"
Write-Host "2. embedding build started with vectorStoreEnabled=true"
Write-Host "3. RAG retrieval path=PGVECTOR, fallbackUsed=false"
Write-Host ""

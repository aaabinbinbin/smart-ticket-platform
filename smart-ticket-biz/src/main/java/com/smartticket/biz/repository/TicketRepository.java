...
public class TicketRepository {
    ...
    public List<Ticket> pageAll(String status, String category, String priority, int offset, int limit) { return ticketMapper.pageAll(status, category, priority, offset, limit); }
    public long countAll(String status, String category, String priority) { return ticketMapper.countAll(status, category, priority); }
    public List<Ticket> pageVisible(Long userId, String status, String category, String priority, int offset, int limit) { return ticketMapper.pageVisible(userId, status, category, priority, offset, limit); }
    public long countVisible(Long userId, String status, String category, String priority) { return ticketMapper.countVisible(userId, status, category, priority); }
